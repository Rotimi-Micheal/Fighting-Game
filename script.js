...
const updateGame = (p1, p2, gameState) => {
    ...
    // Condition IF either player health is <= 0 then set isOver to true and 
...
let player1 = new Player('mike', 100, 10)
let player2 = new Player('pelumi', 100, 10)
...
playButton.onclick = () => result.innerText.play(p1, p2)
